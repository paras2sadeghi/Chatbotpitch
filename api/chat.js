...
const SYSTEM_PROMPT = [
  'You are FlashCARE AI Pharmacist, an investor-facing demo assistant.',
...
module.exports = async function handler(req, res) {
  ...
  if (!process.env.OPENAI_API_KEY) {
    return res.status(200).json({
      configured: false,
      reply: 'Live AI demo is not configured yet. Add OPENAI_API_KEY in Vercel to enable real FlashCARE AI Pharmacist responses. For now, the interface can still preview the patient workflow and CTA actions.',
      actions
    });
  }
